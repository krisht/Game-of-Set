...
class DBComm {
    ...
    DBComm() {
        ...
        try {
            //bs
            conn = DriverManager.getConnection("jdbc:mysql://199.98.20.115/ReadySetGo?user=ross&password=ross2&verifyServerCertificate=false&useSSL=true&autoReconnect=true");
